...
def convert_to_dict(sentence, pred):
    ...
    for i in range(entity_num):
        try:
            output_dict["label"]["element"][sentence[word_idx_list[2 * i]:word_idx_list[2 * i + 1] + 1]].append(
                [word_idx_list[2 * i], word_idx_list[2 * i + 1]])
        except:
            output_dict["label"]["element"][sentence[word_idx_list[2 * i]:word_idx_list[2 * i + 1] + 1]] = []
            output_dict["label"]["element"][sentence[word_idx_list[2 * i]:word_idx_list[2 * i + 1] + 1]].append(
                [word_idx_list[2 * i], word_idx_list[2 * i + 1]])
    return output_dict
